...
const steps = [
  {
    icon: <FaUserPlus className="text-5xl text-secondary mx-auto mb-4" />,
    title: "Register & Explore",
    description:
      "Sign up using email or Google and start exploring tutors by category, language, and expertise.",
  },
  {
    icon: <FaChalkboardTeacher className="text-5xl text-secondary mx-auto mb-4" />,
  ...
  {
    icon: <FaBookOpen className="text-5xl text-secondary mx-auto mb-4" />,
  ...
  {
    icon: <FaStar className="text-5xl text-secondary mx-auto mb-4" />,
    title: "Book & Review",
    description:
...
const HowItWorks = () => {
  return (
    <div className="w-11/12 mx-auto py-10">
      <h2 className="text-2xl md:text-2xl lg:text-3xl font-bold text-center mb-10">How It Works</h2>
